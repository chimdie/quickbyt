...
export default function Chats() {
  ...
  return (
    <>
      ...
      {/* <Main fixed> */}
      <section className='flex h-full gap-6 border-4 border-red-800'>
        {/* Left Side */}
        <div className='flex w-full flex-col gap-2 sm:w-56 lg:w-72 2xl:w-80'>
          ...
          <ScrollArea className='-mx-3 h-full border border-red-600 p-3'>
        ...
        {selectedUser ? (
          ...
          >
            {/* Top Part */}
            <div className='mb-1 flex flex-none justify-between rounded-t-md border border-green-600 bg-secondary p-4 shadow-lg'>
              {/* Left */}
            ...
            {/* Conversation */}
            <div className='flex flex-1 flex-col gap-2 rounded-md border border-red-600 px-4 pb-4 pt-0'>
